...
class teams extends \admin_setting {
    ...
    public function output_html($data, $query = '') {
        ...
        $customizeurl = new \moodle_url('/local/o365/acp.php', ['mode' => 'teamcustom']);
        $options = [
            'off' => get_string('acp_teamcustom_off', 'local_o365'),
            'oncustom' => get_string('acp_teamcustom_oncustom', 'local_o365', $customizeurl->out()),
            'onall' => get_string('acp_teamcustom_onall', 'local_o365'),
        ];
